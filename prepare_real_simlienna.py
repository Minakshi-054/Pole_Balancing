...
data_root = Path("/data/stg60/Data_lienna/version_1")
data_lienna_par = Path("/home/Students/stg60/Data/data/newmats/real/Prediction_project/Leanna_for_parameter_est/")
data_lienna_pred = Path("/home/Students/stg60/Data/data/newmats/real/Prediction_project/Leanna_for_prediction/")
...
def getAllMats(path = "/data/stg60/newchaos/data/mats/synthetic/folder001/", sample = None, filter_required = True, L = 128, timetopredict = 1.96, samplingrate = 100):
...
if __name__ == '__main__':
    # """
    create_Real_Data(data_lienna_pred, mode = "pred")
    create_Real_Data(data_lienna_par, mode = "par")
