...
data_root = Path("/data/stg60/karldata/version_10/")
data_karl_par = Path("/data/stg60/realdata/karl_data/Karl_for_parameter_est/")
data_karl_pred = Path("/data/stg60/realdata/karl_data/Karl_for_prediction/")
#data_karl_test=Path("/data/stg60/realdata/karl/")
...
if __name__ == '__main__':
    # """
    create_Real_Data(data_karl_pred, mode = "pred")
    create_Real_Data(data_karl_par, mode = "par")
    #create_Real_Data(data_karl_test, mode = "karl")
