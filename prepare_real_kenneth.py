...
data_root = Path("/data/stg60/Data_lienna/version_10")
data_kenneth_par = Path("/home/Students/stg60/Data/data/newmats/real/Prediction_project/Kenneth_for_parameter_est/")
data_kenneth_pred = Path("/home/Students/stg60/Data/data/newmats/real/Prediction_project/Kenneth_for_prediction/")
#data_milton_test=Path("/home/Students/stg60/Data/data/newmats/real/Prediction_project/Milton_for_pred_test/")
...
def getAllMats(path = "/data/stg60/newchaos/data/mats/synthetic/folder010/", sample = None, filter_required = True, L = 128, timetopredict = 1.96, samplingrate = 100):
...
if __name__ == '__main__':
    # """
    create_Real_Data(data_kenneth_pred, mode = "pred")
    create_Real_Data(data_kenneth_par, mode = "par")
    # create_Real_Data(data_milton_test, mode="test")
