...
data_root = Path("/data/stg60/imbalanceddata/version_9/")
...
#data_milton_real = Path("/home/Students/stg60/Data/data/newmats/real/Prediction_project/")
...
def getAllMats(path = "/data/stg60/newchaos/data/mats/synthetic/folder009/", sample = None, filter_required = True, L = 128, timetopredict = 1.96, samplingrate = 100):
