...
data_root = Path("/data/stg60/newmilton_processeddata/version_10/")
data_milton_par = Path("/data/stg60/new_miltondata/real/")
...
def getAllMats(path = "/data/stg60/new_miltondata/folder009/", sample = None, filter_required = True, L = 128, timetopredict = 1.96, samplingrate = 100):
...
def prepareData(path, cutoff = 16, delay = 23, L = 128, timetopredict = 1.96, samplingrate = 100, fall_stride = 1, start_index = 1024, end_index = None, scale = True):
