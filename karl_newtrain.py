...
if not sanity_check:    
    checkpoint_root = f"/data/stg60/karl_transferlearningModel/version_{version_model}"
else:
...
root = Path(f"/data/stg60/transfer_learningdata/Karl/version_{version_data}")
...
trainpath = root / 'karl_train.npz'
valpath = root / 'Karl_test.npz'
