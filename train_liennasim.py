...
root = Path(f"/data/stg60/lienna_Data/version_{version_data}")
...
with open(f"{cat_root}/version_{version_catalog}.txt", "w") as f:
    ...
    with open("preparedata_real.py", "r") as p:
        header_ = """
        ########################################################
        ###############       preparedata_real.py       #############
        ########################################################
    ...
    with open("train_real_data.py", "r") as t:
        header_ = """
        ########################################################
        ###############       train_real_data.py       ###################
        ########################################################
...
if mode == "train":
    ...
    print("Model Evaluation Started on test_sim set")
    ...
    with open(f"{rep_root}/testing_test_report_version_{version_catalog}_leanna.txt","w") as f:
        f.write(report)
    ...
    # with open(f"{rep_root}/testing_val_report_version_{version_catalog}_milton.txt","w") as f:
    #     f.write(report)
